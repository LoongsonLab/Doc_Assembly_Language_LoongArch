...
project = u'汇编语言编程基础 基于LoongArch'

# 子标题，显示在PDF封面第二行，不显示子标题则设置为''或注释掉
subtitle = u'基于LoongArch'

# 文档作者，默认为 '龙芯中科技术股份有限公司'，默认根据中英文自动切换，显示在PDF封面以及内容页左下角
author = u'龙芯实验室'

# 版权信息，默认为 '2022-2026, 龙芯中科技术股份有限公司'，根据中英文自动切换
copyright = u'2022-2026, 龙芯中科技术股份有限公司'
